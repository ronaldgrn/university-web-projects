...
// Create Players
var P1 = new Zero(canvasP1, "John Doe", 1000, 10, 10, 2, LAZORS);
var P2 = new GreenZero(canvasP2, "Jane Smith", 1000, canvasWidth - 100, canvasHeight - 100, 2, LAZORS);
...
var handleInput = function handleInput() {
	...
	// Player1 Movement
	if (32 in keysDown) P1.fire();

	if (65 in keysDown) P1.moveLeft();

	if (87 in keysDown) P1.moveUp();

	if (68 in keysDown) P1.moveRight();

	if (83 in keysDown) P1.moveDown();
	...
	// Player2 Movement
	if (96 in keysDown) P2.fire();

	if (37 in keysDown) P2.moveLeft();

	if (38 in keysDown) P2.moveUp();

	if (39 in keysDown) P2.moveRight();

	if (40 in keysDown) P2.moveDown();

	if (!(37 in keysDown || 38 in keysDown || 39 in keysDown || 40 in keysDown || 96 in keysDown)) {
		P2.moveIdle();
	}
};

var updateHealth = function updateHealth() {
	if (P1.health <= 0) {
		P1.health = 0;
		endgame(2);
		// P1.die();
